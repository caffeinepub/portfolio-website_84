...
export class Backend implements backendInterface {
    ...
    async getHeroSection(): Promise<string> {
        if (this.processError) {
            try {
    ...
    async getProfileImage(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getProfileImage();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateHeroSection(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateProfileImage(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProfileImage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
