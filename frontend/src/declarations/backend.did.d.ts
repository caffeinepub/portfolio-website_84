...
export interface _SERVICE {
  ...
  'getHeroSection' : ActorMethod<[], string>,
  'getProfileImage' : ActorMethod<[], string>,
  ...
  'updateHeroSection' : ActorMethod<[string], undefined>,
  'updateProfileImage' : ActorMethod<[string], undefined>,
